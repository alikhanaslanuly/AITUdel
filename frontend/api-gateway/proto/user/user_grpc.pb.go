...
const (
	...
	UserService_SendNotification_FullMethodName    = "/user.UserService/SendNotification"
	UserService_Logout_FullMethodName              = "/user.UserService/Logout"
	UserService_GetCourier_FullMethodName          = "/user.UserService/GetCourier"
	UserService_UpdateCourierStatus_FullMethodName = "/user.UserService/UpdateCourierStatus"
)
...
func (c *userServiceClient) SendNotification(ctx context.Context, in *SendNotificationRequest, opts ...grpc.CallOption) (*SendNotificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendNotificationResponse)
	err := c.cc.Invoke(ctx, UserService_SendNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetCourier(ctx context.Context, in *GetCourierRequest, opts ...grpc.CallOption) (*GetCourierResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCourierResponse)
	err := c.cc.Invoke(ctx, UserService_GetCourier_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) UpdateCourierStatus(ctx context.Context, in *UpdateCourierStatusRequest, opts ...grpc.CallOption) (*UpdateCourierStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateCourierStatusResponse)
	err := c.cc.Invoke(ctx, UserService_UpdateCourierStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) SendNotification(context.Context, *SendNotificationRequest) (*SendNotificationResponse, error) {
...
func (UnimplementedUserServiceServer) GetCourier(context.Context, *GetCourierRequest) (*GetCourierResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCourier not implemented")
}
func (UnimplementedUserServiceServer) UpdateCourierStatus(context.Context, *UpdateCourierStatusRequest) (*UpdateCourierStatusResponse, error) {
...
func _UserService_SendNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendNotificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SendNotification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SendNotification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SendNotification(ctx, req.(*SendNotificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_GetCourier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCourierRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetCourier(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetCourier_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetCourier(ctx, req.(*GetCourierRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_UpdateCourierStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateCourierStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).UpdateCourierStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpdateCourierStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateCourierStatus(ctx, req.(*UpdateCourierStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_SendNotification_Handler,
		},
		{
			MethodName: "Logout",
		...
		},
		{
			...
			Handler:    _UserService_GetCourier_Handler,
		},
		{
			MethodName: "UpdateCourierStatus",
			Handler:    _UserService_UpdateCourierStatus_Handler,
		},
	},
